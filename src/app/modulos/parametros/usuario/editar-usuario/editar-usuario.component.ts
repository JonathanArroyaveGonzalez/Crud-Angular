...
export class EditarUsuarioComponent implements OnInit {
  ...
  BuscarRegistro(){
    ...
    this.servicio.BuscarUsuario(this.recordId).subscribe({
      ...
      this.ObtenerFormGroup['identificacion'].setValue(datos.identificacion);
      this.ObtenerFormGroup['nombres'].setValue(datos.nombres);
      this.ObtenerFormGroup['apellidos'].setValue(datos.apellidos);
      this.ObtenerFormGroup['perfil'].setValue(datos.perfil);
      this.ObtenerFormGroup['password'].setValue(datos.password);
   },
      error: (err)=>{
